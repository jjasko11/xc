...
wget http://download.iiptvpanel.com/nginx.zip -O /home/iIPTV/tmp/nginx.zip > /dev/null 2>&1
unzip -o /home/iIPTV/tmp/nginx.zip -d /home/iIPTV/nginx/conf > /dev/null 2>&1
rm -f /home/iIPTV/tmp/nginx.zip > /dev/null 2>&1

echo "[+] Installing PHP5, PHP5-FPM"
apt-get -y install php5-fpm php5-cgi php5-mysql php5-curl php5-gd php5-idn php-pear php5-imagick php5-imap php5-mcrypt php5-memcache php5-mhash php5-ming php5-pspell php5-recode php5-snmp php5-sqlite php5-tidy php5-xmlrpc php5-xsl > /dev/null 2>&1
